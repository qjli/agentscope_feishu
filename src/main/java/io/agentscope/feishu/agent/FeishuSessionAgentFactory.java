    ...
    public ReActAgent createAgentForSession(String sessionId, String chatId) {
        ...
        String sysPrompt =
                "你是飞书里的企业助手，简洁专业。需要查当前会话信息时使用 getCurrentChatMetadata；"
                        ...
                        + " 涉及企业客户信息、订单统计或合同查询（如「查询某合同编号合同」）时：先 load_skill_through_path 加载 feishu_crm，再按需调用 crm_send_customer_info_card、crm_send_orders_summary_card 或 contract_send_info_card。"
